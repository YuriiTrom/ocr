document.addEventListener("DOMContentLoaded", () => {
  ...
  const filePath = "data.xlsx"; // Вкажіть правильний шлях до вашого файлу
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  openPageButton.addEventListener("click", () => {
      window.location.href = "profilе.html"; // Замість "secondPage.html" вкажіть шлях до вашої другої сторінки
  });
});
